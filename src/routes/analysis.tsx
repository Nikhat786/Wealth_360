...
export const Route = createFileRoute("/analysis")({
  head: () => ({
    meta: [
      { title: "Building your Wealth360 — m.Stock" },
      {
        name: "description",
        content:
          "We are analysing your cashflow, net worth, investments, liabilities, goals, insurance, risk and continuity.",
      },
      { property: "og:title", content: "Building your Wealth360 — m.Stock" },
      {
        property: "og:description",
        content: "A full read of your financial life before your dashboard opens.",
      },
    ],
  }),
  component: Analysis,
...
export function Analysis() {
  ...
  useEffect(() => {
    if (done >= checks.length) {
      markAnalysisSeen();
      const t = setTimeout(() => void navigate({ to: "/wealth360/dashboard" }), 900);
