...
export const Route = createFileRoute("/welcome")({
  head: () => ({
    meta: [
      { title: "Wealth360 — your whole financial life in one view | m.Stock" },
      {
        name: "description",
        content:
          "Bring investments, cashflow, goals, protection, debt and family wealth into one intelligent view across Know, Grow, Protect, Plan and Transfer.",
      },
      { property: "og:title", content: "Wealth360 — your whole financial life in one view" },
      {
        property: "og:description",
        content:
          "Goal-based investing, net-worth tracking, Wealth Health Score, protection analysis and wealth transfer planning.",
      },
    ],
  }),
  component: Welcome,
...
const benefits = [
  ...
  { icon: Landmark, label: "Net-worth tracking" },
        ...
        <section className="gradient-navy text-navy-foreground shadow-raised relative overflow-hidden rounded-2xl px-6 py-12 sm:px-10 sm:py-16">
          ...
          <div className="relative max-w-3xl">
            <span className="bg-white/10 inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium">
              <Sparkles className="size-3.5" /> m.Stock Wealth360
            </span>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Button asChild size="lg" className="bg-gold text-gold-foreground hover:bg-gold/90">
                <Link to="/wealth360/journey">
                  Start my Wealth360 <ArrowRight className="ml-1.5 size-4" />
                </Link>
              </Button>
              <Button
                size="lg"
