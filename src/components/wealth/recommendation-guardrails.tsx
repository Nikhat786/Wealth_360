...
export interface RecommendationGuardrailData {
  why: string;
  considered: string[];
  missing: string[];
...
export function RecommendationGuardrails({ data }: { data: RecommendationGuardrailData }) {
...
export function guardrailsFor(actionId: string, why: string, confidence: RecommendationGuardrailData["confidence"]): RecommendationGuardrailData {
