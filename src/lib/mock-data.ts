...
export interface Goal {
  id: string;
  name: string;
  icon: "retirement" | "education" | "home" | "travel" | "shield" | "car";
  target: number;
  saved: number;
...
export const user = {
  ...
  kyc: [
    { label: "PAN verified", status: "Verified" as const, date: "12 Aug 2021" },
    { label: "Aadhaar e-KYC", status: "Verified" as const, date: "12 Aug 2021" },
    { label: "Bank mandate", status: "Verified" as const, date: "14 Aug 2021" },
    { label: "Nominee details", status: "Pending" as const, date: "Action needed" },
    { label: "FATCA declaration", status: "Verified" as const, date: "03 Jan 2024" },
  ],
};
...
export const baseScoreInputs: ScoreInputs = {
...
function idleCashMonths(): number {
