...
export const Route = createFileRoute("/score")({
  head: () => ({
    meta: [
      { title: "My Wealth360 Score — m.Stock" },
      {
        name: "description",
        content:
          "See the six pillars behind your Wealth360 score and simulate what-if changes instantly.",
      },
      { property: "og:title", content: "My Wealth360 Score — m.Stock" },
      {
        property: "og:description",
        content: "Six pillars, live grading and a what-if simulator for your score.",
      },
    ],
  }),
  component: ScorePage,
