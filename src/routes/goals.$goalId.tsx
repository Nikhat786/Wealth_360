...
export const Route = createFileRoute("/goals/$goalId")({
  head: () => ({
    meta: [
      { title: "Goal detail — m.Stock Wealth360" },
      {
        name: "description",
        content:
          "Projection, funding gap and contribution simulator for this Wealth360 goal.",
      },
      { property: "og:title", content: "Goal detail — m.Stock Wealth360" },
      {
        property: "og:description",
        content: "See the projection and adjust monthly contributions for this goal.",
      },
    ],
  }),
