...
export const Route = createFileRoute("/debt")({
  head: () => ({ meta: [{ title: "Debt Optimiser — m.Stock Wealth360" }] }),
  component: DebtPage,
});
...
function DebtPage() {
  ...
  const summary = debtSummary(answers.liabilities, derivedIncome(answers));
