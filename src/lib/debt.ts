import type { LiabilityRecord } from "@/context/app-context";

export interface DebtSummary {
  totalOutstanding: number;
  totalEmi: number;
  debtToIncome: number;
  highestCost: LiabilityRecord | null;
  weightedRate: number;
}

export function debtSummary(liabilities: LiabilityRecord[], monthlyIncome: number): DebtSummary {
...
export function repaymentStrategy(summary: DebtSummary, extraMonthly: number) {
